                    ...
                    if(temp[0]=="phase2"){
                        ...
                        string mess = "phase2.1:"+to_string(client_id);
                            ...
                            if(temp[1]!="0"){
                                ...
                                while(iterator+1!=temp.end()){
                                //cout<<socketmap2[temp[1]]<<" "<<socketmap1[temp[1]]<<endl;
                                    string file_path = dir_path+"Downloaded/"+*iterator;
                                    iterator+=1;
                                //cout<<file_path<<endl;
                                    fromthis.push_back(make_tuple(u_id,file_path,stoi(*iterator)));
                                    iterator+=1;
                                }
                            }
                        }
...
//phase 2
    ...
    // cout<<"bhejna files:"<<endl;
    // for(auto item : C.bhejna){
    //     cout<<item.first<<" ";
    //     for(auto it:item.second){
    //         cout<<item.first<<" ";
    //     }
    //     cout<<endl;
    // }
    // cout<<"lena files:"<<endl;
    // for(auto item : C.lena){
    //     cout<<item.first<<" ";
    //     for(auto it:item.second){
    //         cout<<it.first<<" ";
    //     }
